...
We are 90% confident that the proportion of mice that died while on the trial is between 0.349 and 0.448. This is a lot smaller than the proportion of mice that died while not on treatment, meaning that the treatment was effective.
